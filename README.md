...
- 최신 설치 파일: [NamePlateStudio-Setup-1.0.0-win-x64.exe](https://github.com/kimothink/NamePlateStudio/releases/download/v1.0.0/NamePlateStudio-Setup-1.0.0-win-x64.exe)
- 소개 페이지: [https://kimothink.github.io/NamePlateStudio/](https://kimothink.github.io/NamePlateStudio/)
- SHA256: `4F57E2F1B9264044C6645989E86C9236CF8A5CC7CF30AFCD38F1AA2D024B5651`
...
```text
dist\NamePlateStudio-Setup-1.0.0-win-x64.exe
```
