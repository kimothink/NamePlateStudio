...
- 최신 설치 파일: [NamePlateStudio-Setup-1.1.1-win-x64.exe](https://github.com/kimothink/NamePlateStudio/releases/download/v1.1.1/NamePlateStudio-Setup-1.1.1-win-x64.exe)
- 소개 페이지: [https://kimothink.github.io/NamePlateStudio/](https://kimothink.github.io/NamePlateStudio/)
- SHA256: `8110D2CEF587A2586B932D1F0ACE5F4C64C3512008C5CC3E3456AE8CC5818237`
...
```text
dist\NamePlateStudio-Setup-1.1.1-win-x64.exe
```
